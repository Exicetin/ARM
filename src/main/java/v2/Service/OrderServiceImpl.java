...
//    }
//    @Override
//    public @NotNull List<OrderResponse> findByIdProg(Integer id) {
//        return orderRepository.findByIdProg(id)
//                .stream()
//                .map(this::buildOrderResponse)
//                .collect(Collectors.toList());
//    }
//    @Override
//    public @NotNull List<OrderResponse> findByNumber(Integer id) {
//        return orderRepository.findByNumber(id)
//                .stream()
//                .map(this::buildOrderResponse)
//                .collect(Collectors.toList());
//    }
//    @Override
//    public @NotNull List<OrderResponse> findByIdTehn(Integer id) {
//        return orderRepository.findByIdTehn(id)
//                .stream()
//                .map(this::buildOrderResponse)
//                .collect(Collectors.toList());
//    }
...
//    @Override
//    public @NotNull List<OrderResponse> findByDateCorr(java.sql.Date date) {
//        return orderRepository.findByDateCorr(date)
//                .stream()
//                .map(this::buildOrderResponse)
//                .collect(Collectors.toList());
//    }
...
//    }
    ...
    @Override
    @Transactional(readOnly = true)
    public OrderResponse findById(@NotNull Integer idOrders) {
        return orderRepository.findById(idOrders)
                .map(this:: buildOrderResponse)
...
//    @Override
//    @Transactional
//    public OrderResponse update(@NotNull Integer IdOrders, @NotNull CreateOrderRequest request) {
//        Orders orders =  orderRepository.findById(IdOrders)
//                .orElseThrow(() -> new EntityNotFoundException("Card " + IdOrders + " is not found"));
